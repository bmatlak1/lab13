...
public class matlak_lab13Test 
{
	...
	public void setUp() throws Exception 
	{
		...
		try
		{
			...
			URL url = getClass().getResource(expectedResultsFilename);
			 File f = new File(url.getPath());
			java.io.BufferedReader input = new java.io.BufferedReader(new FileReader(f));
	...
	public void testGetTotalCount() {
		assertEquals(lab.getTotalCount(), 1000l);
	}

	@Test
	public void testGetOddCount() {
		assertEquals(lab.getOddCount(), 507l);
	}

	@Test
	public void testGetEvenCount() {
		assertEquals(lab.getEvenCount(), 493l);
	}

	@Test
	public void testGetDistinctGreaterThanFiveCount() {
		assertEquals(lab.getDistinctGreaterThanFiveCount(), 94l);
	}
